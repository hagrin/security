...
- Perpetual Preferred Stock - the concept behind this level is that it removes the maturity date that the convertible bonds have, it pushes out the dilution as opposed to the ATM strategy, but it does pay a (conditional amybe) dividend which will require some type of cash flow.
